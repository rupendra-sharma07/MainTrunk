...
rel=stylesheet type=text/css href="Load.ashx?type=style&amp;file=IE.css"><![endif]-->
			...
			var OxOb45d=["nocancel"];top[OxOb45d[0]]=true;
			</script>
			<%}else{%>
			<script type="text/javascript">
			var OxOd24e=["nocancel"];top[OxOd24e[0]]=false;
			</script>
			<%}%>
			<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1003&amp;file=Dialog_TagHead.js"></script>
	</head>
	<body>
		...
		<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1003&amp;file=Dialog_TagFoot.js"></script>
	</body>
</HTML>
