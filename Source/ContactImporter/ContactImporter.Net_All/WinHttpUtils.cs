...
namespace Improsys.ContactImporter.Util
{
	...
	/// </summary>
	internal class WinHttpUtils:IDisposable
	{
		...
		public string GetHttpResponse(string url, bool includeHeader,string postFields, string referer, bool redirect)
		{
			...
			try
			{
				...
				winhttp.set_Option(WinHttpRequestOption.WinHttpRequestOption_SslErrorIgnoreFlags,(object)0x3300);
				...
				//winhttp.SetProxy(2,"127.0.0.1:8888",null);
				winhttp.Send(obj);
				if(includeHeader)
				{
