<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OrderCredit.aspx.cs" Inherits="Tribute_OrderCredit" %>
                            ...
                            <div class="yt-Panel-Primary">
                                ...
                                <fieldset class="yt-Form">
                                    ...
                                    <p style="font-size: 20px; font-family: Lucida Sans;">
                                        How do credits work ?</p>
                                    <div style="font-size: 12px; font-family: Lucida Sans;">
                                        Credits are Your Tribute's very own currency. Purchase credits and spend them whenever
                                        you order a Tribute. The credit cost depends on the type of Tribute you purchase.
                                        the more credits you purchase, the more you save!</div>
                                    <br />
                                    ...
                                    <div style="color: Red">
                                        *To order credits offline with a check or credit card, <a href="../assets/Pdf/credit_order_form.pdf"
                                            target="_blank" style="color: red">download and complete this form</a>.
                                    </div>
                                    <br />
                                    <p>
                                    ...
                                    <asp:UpdatePanel ID="pnlCoupon" runat="server" UpdateMode="Conditional">
                                        <ContentTemplate>
                                            <div id="PnlPaymentDetails" runat="server" visible="true">
                                    ...
                                    <div class="yt-Form-Buttons">
                                        <div class="yt-Form-Submit">
                                            <asp:LinkButton ID="lbtnPay" CssClass="yt-Button yt-ArrowButton" runat="server" OnClick="lbtnPay_Click"
                                                OnClientClick="OnPayClick()">Pay!</asp:LinkButton>
