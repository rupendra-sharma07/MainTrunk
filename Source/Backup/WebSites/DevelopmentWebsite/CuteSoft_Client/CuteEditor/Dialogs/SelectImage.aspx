...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head runat="server">
		...
		var OxO1fb4=[];function PostBackAction(){<%=Page.GetPostBackEventReference(hiddenAction,"")%>;} ;
		</script>
		<style type="text/css">	
...
<input type="text" id="TargetUrl" style="width:400px" name="TargetUrl" runat="server" />												
	...
	<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1003&file=Dialog_SelectImage.js"></script>
</html>
