...
var _INITIAL_WIDTH			= 324;		// Initial width of the box (px)
var _INITIAL_HEIGHT			= 300;		// Initial height of the box (px)
var _CONTENTS_WIDTH 		= 324;		// Actual width of the box (px)
var _CONTENTS_HEIGHT		= 300;		// Actual height of the box (px)
var _DEF_CONTENTS_WIDTH		= 324;		// Default width of the box (px) - used for resetting when a different setting was used
var _DEF_CONTENTS_HEIGHT	= 300;		// Default height of the box (px) - used for resetting when a different setting was used
...
//		this.eventKeyDown = this.keyboardListener.bindWithEvent(this);
		...
		this.contents = new Element('div').setProperty('id', 'mb_contents_').injectInside(this.center);
		...
		this.caption = new Element('h2').setProperty('id', 'mb_caption').injectInside(this.center);
		...
		this.fx = {
			...
			contents: 	this.contents.effect('opacity', { duration: 15, onComplete: nextEffect }),
...
//		document[fn]('keydown', this.eventKeyDown);
	...
	htmlBox: function(sHtml, sLinkTitle, sLinkRel) {
		this.href = "";
		this.title = sLinkTitle;
		this.rel = sLinkRel;
		this.position();
