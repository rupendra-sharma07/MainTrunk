<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ChannelTribute.aspx.cs" Inherits="Tribute_ChannelTribute"
    Title="Channel Tributes" MasterPageFile="~/Shared/ChannelTribute.master" %>
...
<asp:Content ID="content1" ContentPlaceHolderID="HeaderContentPlaceHolder" runat="Server">
    ...
    <div class="yt-Breadcrumbs">
        <a href="http://<%=strBcTributeType%>.<%=TributesPortal.Utilities.WebConfig.TopLevelDomain%>"><%=strChannelHomepage%></a> <span class="selected">All Tributes</span>
    </div>
</asp:Content>
