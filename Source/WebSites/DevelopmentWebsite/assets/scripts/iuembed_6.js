    ...
    javaDetector: {
        ...
        getJREs: function() {
            if (this.list == null) {
                ...
                if (this.isPluginInstalled()) {
                    ...
                    if (IUCommon.browser.isOpera || (ua.indexOf('mac') > -1 && ua.indexOf('firefox') != -1)) { // Opera & firefox on Mac
                        var a = window.java, c;
                        try {
        ...
        writePluginTag: function() {
            if (IUCommon.browser.isIE && this.isActiveXEnabled) {
                ...
                'id="deployJavaPlugin" width="0" height="0" style="position: absolute; left: -10px;">' +
                '<' + '/' + 'object' + '>');
            ...
            if (IUCommon.browser.isWinIE || (IUCommon.browser.isKhtml && !IUCommon.browser.isChrome)) {
                if (IUCommon.browser.isWinIE) {
                    ...
                    if (!IUCommon.browser.isIE64) {
                        sb.add(" codebase=\"" + window.location.protocol + "//java.sun.com/update/1.5.0/jinstall-1_5_0-windows-i586.cab#Version=1,5,0,0\"");
                    }
