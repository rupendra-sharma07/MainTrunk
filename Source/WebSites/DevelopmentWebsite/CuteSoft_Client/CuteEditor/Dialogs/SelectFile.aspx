...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head runat="server">
		...
		var OxO3359=[];function PostBackAction(){<%=Page.GetPostBackEventReference(hiddenAction,"")%>;} ;
			</script>
		<style type="text/css">
...
<input class="formbutton" type="button" value="  [[Cancel]]  " onclick="do_Close()" id="Button2" name="Button2" />
   ...
   protected int GetUsedPercent()
	...
	return w;      
		...
		<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1003&amp;file=Dialog_SelectFile.js"></script>
	</body>
</html>