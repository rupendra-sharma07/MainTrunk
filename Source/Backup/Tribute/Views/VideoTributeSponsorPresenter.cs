...
{
    public class VideoTributeSponsorPresenter : Presenter<ITributeSponsor>
    {    
        private TributeController _controller;
        public VideoTributeSponsorPresenter([CreateNew] TributeController controller)
        {
        ...
        public void GetTributeSessionForId(int tributeId)
        {
