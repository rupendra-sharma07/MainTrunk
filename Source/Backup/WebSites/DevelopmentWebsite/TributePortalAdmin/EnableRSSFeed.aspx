    ...
    <asp:Label ID="lblUpdatedFeed" runat="server" ForeColor="Red" Visible="false"></asp:Label>
        <table id="Table1" width="100%" runat="server" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td >
                    <strong>Enable XML Feed <asp:RadioButton ID="rdoBtnXML" GroupName="RssXml" runat="server" OnCheckedChanged="RadioSelection_Changed"
                        /></strong>
                </td>
                <td  >
                    <strong>Enable RSS Feed <asp:RadioButton ID="rdoBtnRSS" GroupName="RssXml" runat="server"  OnCheckedChanged="RadioSelection_Changed"
                        /></strong>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <asp:Button ID="btnCancel" runat="server" onclick="btnCancel_Click" 
                        Text="Cancel" />
                    &nbsp;
                    <asp:Button ID="btnSubmit" runat="server" Text="Enable" 
