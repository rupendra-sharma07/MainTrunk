...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head runat="server">
		...
		var OxO6b29=[];function PostBackAction(){<%=Page.GetPostBackEventReference(hiddenAction,"")%>;} ;
		</script>
		<style type="text/css">
...
<input type="checkbox" name="WindowlessVideo" onchange="do_preview()" onpropertychange="do_preview()" id="WindowlessVideo" value="windowlessVideo" /></td>
	...
	<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1003&file=Dialog_InsertMedia.js"></script>
</html>
