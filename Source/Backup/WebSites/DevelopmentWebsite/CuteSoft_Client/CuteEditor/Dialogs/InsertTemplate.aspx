...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head runat="server">
		...
		var OxOf145=[];function PostBackAction(){<%=Page.GetPostBackEventReference(hiddenAction,"")%>;} ;
		</script>
...
<input class="formbutton" type="button" value="[[Cancel]]" onclick="do_Close()" />
	...
	<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1003&file=Dialog_InsertTemplate.js"></script>
</html>
