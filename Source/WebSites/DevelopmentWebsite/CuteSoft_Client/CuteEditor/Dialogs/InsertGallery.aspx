...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head runat="server">
		...
		<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1003&amp;file=Dialog_gallery_spring.js"></script>
		<script type="text/javascript">		
			var OxO8703=[];function Check(Ox12,Ox27){} ;function showTooltip(Ox42,obj,Ox43){} ;function insert(src){} ;function delayhidetip(){} ;
		</script>
		<style type="text/css">	 
	...
	<body>
		...
		<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1003&amp;file=DialogFoot.js"></script>
		<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1003&amp;file=Dialog_InsertGallery.js"></script>
	</body>
	<script runat="server">
