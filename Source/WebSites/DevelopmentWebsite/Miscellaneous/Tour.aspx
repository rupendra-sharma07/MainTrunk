...
xml:lang="en" lang="en">
<head>
    <title id="tourTitle" runat="server">Tour | How to create an online memorial for a loved one - Your Tribute</title>
            ...
            <div class="yt-InnerContentContainer">
                <div class="yt-ContentPrimaryContainer">
                    <div class="yt-Panel-Primary-MT">
                        ...
                        <div class="tourIntro">
                            <p>
                                Your <%=ConfigurationManager.AppSettings["ApplicationWord"].ToString()%> is a web-based tool that lets you set up a personalized online memorial
                                website to share and remember the life of a special someone. Online memorials can
                                be created in minutes, but remain online forever to provide an everlasting record
                                of the person's life. Create a FREE obituary and share personal memories with friends
                                and family using the Story, Guestbook and Gifts features.
                            </p>
                            <br />
                            <p>
                                Upgrade to a paid Premium Obituary or Memorial Tribute website to take advantage of all
                                of Your Tribute's features. Add an event to plan the memorial service and memorial
                                related events. Share high-resolution photos and family videos and let your guests
                                do the same. You can also add Notes to share thoughts, personal stories and other
                                information with visitors to the online memorial.
                            </p>
                        </div>
                        ...
                        <div class="tourBlueBox">
                            ...
                            <div class="textSect">
                                ...
                                <p>
                                    Your <%=ConfigurationManager.AppSettings["ApplicationWord"].ToString()%> is integrated with Facebook, which makes it easy for you to share the
                                    online memorial website with your Facebook friends. You can log in to Your <%=ConfigurationManager.AppSettings["ApplicationWord"].ToString()%>
                                    ...
                                    what’s happening on Your <%=ConfigurationManager.AppSettings["ApplicationWord"].ToString()%>.
                                </p>
                            </div>
                        </div>
                        <div class="hack-clearBoth">
                        ...
                        <div class="rightSideTourBlock">
                            ...
                            <div class="tourText">
                                <p>
                                    ...
                                    You can also add a title and description to your photos and albums. We store the originals of
                                    every photo uploaded and have a slideshow feature to make it easy to view your photos.
                                </p>
                            </div>
                            <div class="tourSmallImage">
                        ...
                        <div class="rightSideTourBlock">
                            ...
                            <div class="tourText">
                                <p>
                                    It is easy to share an online memorial with your friends and family. Each page of the
                                    memorial website has a variety of sharing options under "<%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%> Tools". You can
                                    email, share on Facebook, share on Twitter, or bookmark and share on a variety of
            ...
            <div class="yt-InnerContentContainer">
                <div class="yt-ContentPrimaryContainer">
                    <div class="yt-Panel-Primary">
                        ...
                        <div class="tourIntro">
                            <p>
                                Your <%=ConfigurationManager.AppSettings["ApplicationWord"].ToString()%> is a web-based tool, that lets you set up a free personal website (a
                                <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%>) to plan, share and remember a significant event or special someone. Create
                                a <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%> for a Wedding, Baby, Birthday, Anniversary, Graduation or Memorial.
                            </p>
                            <br />
                            <p>
                                Simple configuration means that creating a <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%> for your event can be completed
                                in minutes. Easy customization allows you to match your <%=ConfigurationManager.AppSettings["ApplicationWord"].ToString()%> to your event’s
                                look and feel. Powerful tools allow you to add custom pages, upload photographs,
                                send online invitations, and more, with very little effort.
                            </p>
                            <br />
                            <p>
                                Click the “Create a <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%>” tab to<br />
                                get started for free, or continue
                                <br />
                                to learn more about Your <%=ConfigurationManager.AppSettings["ApplicationWord"].ToString()%>.
                            </p>
                        </div>
                        ...
                        <div class="createTributeFloatingButtonDiv">
                            <a class="createTributeFloatingButton" href="<%=Session["APP_BASE_DOMAIN"]%>pricing.aspx">
                                Create <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%></a>
                        </div>
                        <%--<div class="hack-clearBoth"></div>
                            <div class="adSpacer30">&nbsp;</div>--%>
                        <div class="hack-clearBoth">
                        ...
                        <div class="leftSideTourBlock">
                            <h3>
                                Create a <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%>
                            </h3>
                            <div class="tourText">
                                <p>
                                    Create a free <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%> for your event in a few simple steps – no obligation and no
                                    credit card required. Select the type of event, name your 
<%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%> and choose a personal
                                    URL. Next, add your 
<%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%> details, photo, and choose your privacy settings. Finally,
                                    choose a package, and click Create. That’s it!
                                </p>
                            </div>
                            <div class="tourSmallImage">
                                <a href="javascript: openwindow('tour_CREATE_Fullsize.jpg')">
                        ...
                        <div class="rightSideTourBlock">
                            ...
                            <div class="tourText">
                                <p>
                                    ...
                                    your theme any time, from any of your pages, using the "Change Theme" link. Live
                                    preview lets you see what the theme will look like.
                                </p>
                            </div>
                            <div class="tourSmallImage">
                                <a href="javascript: openwindow('tour_THEME_Fullsize.jpg')">
...
<%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%> name and photo, location,
                                    date and more. These are set up during 
<%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%> creation, but can be updated at any
                                    time. We recommend you start by adding to this page, it could include important
                                    dates, milestones, history, places, trivia, fun facts and more.
                                </p>
                            </div>
                            <div class="tourSmallImage">
                                <a href="javascript: openwindow('tour_STORY_Fullsize.jpg')">
...
<%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%>. Add standard event
                                    details such as date, time, location, organizer, description and more. Make your
                                    event public or private and optionally ask for meal preferences. You can view and
                                    manage your guest list online and even export it to a spreadsheet.
                                </p>
                            </div>
                            <div class="tourSmallImage">
                                <a href="javascript: openwindow('tour_EVENT_Fullsize.jpg')">
                        ...
                        <div class="tourBlueBox">
                            ...
                            <div class="textSect">
                                ...
                                <p>
                                    Send beautiful online invitations, for FREE, from your <%=ConfigurationManager.AppSettings["ApplicationWord"].ToString()%>
. Choose from one
                                    of our numerous stylish designs and add a custom message to your online invitation.
                                    All invitations include event details, a link to your <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%> and a link to RSVP
                                    to your event. Adding your contacts is a breeze. Manually add email addresses or
                                    import contacts from Hotmail, Gmail, AOL or Yahoo. You can also connect to Facebook
                                    and invite your Facebook friends to your event. Add more contacts and send additional
                                    free online invitations any time!
                                </p>
                            </div>
                        </div>
                        <div class="hack-clearBoth">
                        ...
                        <div class="leftSideTourBlock">
                            ...
                            <div class="tourText">
                                <p>
                                    ...
                                    your <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%> of important thoughts and updates. A Note can also be used like a page
                                    on a website. Use the Note to include links, graphics and other info. The most recent
                                    note will be featured on your <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%>'s homepage.
                                </p>
                            </div>
                            <div class="tourSmallImage">
                                <a href="javascript: openwindow('tour_NOTES_Fullsize.jpg')">
                        ...
                        <div class="rightSideTourBlock">
                            ...
                            <div class="tourText">
                                <p>
                                    Add an unlimited number of photo albums and photos to your <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%> (your friends
                                    and family can contribute their photos as well). You can add a title and description
                                    to every photo and album. We store the original of each photo uploaded and have
                                    a slideshow feature to make it easy to view your photos.
                                </p>
                            </div>
                            <div class="tourSmallImage">
                                <a href="javascript: openwindow('tour_PHOTOS_Fullsize.jpg')">
                        ...
                        <div class="leftSideTourBlock">
                            ...
                            <div class="tourText">
                                <p>
                                    There are a number of ways your friends and family can contribute to your <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%>.
                        ...
                        <div class="rightSideTourBlock">
                            <h3 class="altTour">
                                Share your <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%>
                            </h3>
                            <div class="tourText">
                                <p>
                                    The best way to announce and share your <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%> is with an eCard. Send one by clicking
                                    "Share This <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%>" on your <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%> homepage. Each page in your <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%> also has
                                    a variety of sharing options under "Tribute Tools". You can Share on Facebook, Twitter,
                                    or on a variety of other popular websites.
                                </p>
                            </div>
                            <div class="tourSmallImage">
                                <a href="javascript: openwindow('tour_SHARE_Fullsize.jpg')">
                        ...
                        <div class="tourBlueBox">
                            ...
                            <div class="textSect">
                                ...
                                <p>
                                    Your <%=ConfigurationManager.AppSettings["ApplicationWord"].ToString()%> is integrated with Facebook, which makes it easy for you to share your
                                    
<%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%> with your Facebook friends. You can log in to Your <%=ConfigurationManager.AppSettings["ApplicationWord"].ToString()%> safely and securely
                                    in one simple step using your Facebook account. When you add content to a <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%>
                                    you will be asked if you want to share your post on your wall. Sharing on your Facebook
                                    wall keeps your Facebook friends up-to-date with what’s happening on your <%=ConfigurationManager.AppSettings["ApplicationWord"].ToString()%>.
                                    When you create an event you can even invite your Facebook friends and manage their
                                    RSVP’s in your <%=ConfigurationManager.AppSettings["ApplicationWordForInternalUse"].ToString()%>.
                                </p>
                            </div>
                        </div>
                        <div class="hack-clearBoth">
