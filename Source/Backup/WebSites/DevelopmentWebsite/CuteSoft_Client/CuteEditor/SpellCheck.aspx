...
<head runat="server" id="Head1">
    ...
    <script type="text/javascript">
		var OxO1d6a=[];window.focus();
    </script>
    <script language="JavaScript" src="Load.ashx?type=script&verfix=1003&file=spell.js" type="text/javascript"></script>
</head>
...
<script type="text/javascript">
var OxO3173=["ua","userAgent","isOpera","opera","isSafari","safari","isGecko","gecko","isWinIE","msie","isMac","Mac","availWidth","dialogWidth","availHeight","dialogHeight"];var _Browser_TypeInfo=null;function Browser__InitType(){if(_Browser_TypeInfo!=null){return ;} ;var Ox4={};Ox4[OxO3173[0]]=navigator[OxO3173[1]].toLowerCase();Ox4[OxO3173[2]]=(Ox4[OxO3173[0]].indexOf(OxO3173[3])>-1);Ox4[OxO3173[4]]=(Ox4[OxO3173[0]].indexOf(OxO3173[5])>-1);Ox4[OxO3173[6]]=(!Ox4[OxO3173[2]]&&!Ox4[OxO3173[4]]&&Ox4[OxO3173[0]].indexOf(OxO3173[7])>-1);Ox4[OxO3173[8]]=(!Ox4[OxO3173[2]]&&Ox4[OxO3173[0]].indexOf(OxO3173[9])>-1);Ox4[OxO3173[10]]=navigator[OxO3173[1]].indexOf(OxO3173[11])!=-1;_Browser_TypeInfo=Ox4;} ;Browser__InitType();function Browser_IsWinIE(){return _Browser_TypeInfo[OxO3173[8]];} ;try{if(Browser_IsWinIE()){top.moveTo((screen[OxO3173[12]]-self[OxO3173[13]])/2,(screen[OxO3173[14]]-self[OxO3173[15]])/2);} else {} ;} catch(x){} ;
</script>
