...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head runat="server" ID="Head1">
		...
		var OxO898f=[];function PostBackAction(){<%=Page.GetPostBackEventReference(hiddenAction,"")%>;} ;
		</script>
		<style type="text/css">	
...
<input type="text" size="2" name="VSpace" onchange="do_preview()" onpropertychange="do_preview()" onkeypress="return CancelEventIfNotDigit()" style="width:80px;" id="VSpace" /></td>
	...
	<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1003&file=Dialog_InsertImage.js"></script>
</html>
<script runat="server">
