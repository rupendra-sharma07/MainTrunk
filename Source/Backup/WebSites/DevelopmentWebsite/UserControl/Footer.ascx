...
<div>
    <div class="yt-Footer">
        <ul class="yt-NavFooter">
            ...
            <li><a href="<%=ConfigurationManager.AppSettings["MomentsBlogUrlMain"]%>">Blog</a></li>
            ...
            <%}
              ...
              { %>
            <li id="LiFuneralResources"><a href="http://resources.yourtribute.com/" target="_blank">
                Funeral Resources</a></li>
            <li id="LiGriefandLoss"><a href="http://resources.yourtribute.com/grief-and-loss/"
                target="_blank">Grief and Loss</a></li>
            <li id="LiResourcePlanning"><a href="http://resources.yourtribute.com/funeral-planning/"
        ...
        <div class="yt-Legal">
            ...
            <ul class="yt-NavFooter">
                ...
                <li><a href="<%=Session["APP_BASE_DOMAIN"]%>privacy.aspx">Privacy</a></li>
            </ul>
            <%}
              else
              { %>
            <ul class="yt-NavFooter">
                <li id="liFooterAbout"><a href="<%=Session["APP_BASE_DOMAIN"]%>about.aspx">About Your
                    Tribute</a></li>
                <li id="liFooterContact"><a href="<%=Session["APP_BASE_DOMAIN"]%>contact.aspx">Contact
                    Us</a></li>
                <li id="liFooterHelp"><a href="http://support.yourtribute.com" target="_blank">Help
                    & Support</a></li>
            </ul>
            <%} %>
        </div>
