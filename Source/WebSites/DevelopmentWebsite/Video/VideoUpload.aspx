                                ...
                                <div class="yt-ContentPrimary">
                                    ...
                                    <table cellspacing="0" cellpadding="0" class="alignTable">
                                        ...
                                        <tr>
                                            ...
                                            <td class="rightOfTableRow lightBgBlue">
                                                <p class="paraVideo">
                                                    <img alt="yes" src="<%=Session["APP_BASE_DOMAIN"]%>assets/images/BlueStar.jpg" /></p>
                                            </td>
                                            <td class="rightOfTableRow lightBgBlue">
                                                <p class="paraVideo">
                                                    <img alt="yes" src="<%=Session["APP_BASE_DOMAIN"]%>assets/images/BlueStar.jpg" /></p>
                                        ...
                                        <tr>
                                            <td><span class="pricingStar"><img alt="yes" src="<%=Session["APP_BASE_DOMAIN"]%>assets/images/WhiteStar.jpg" /> </span>
                                                <span class="pricingText">Free "Video Only" and "Video Tribute" accounts have banner advertising.
                                                </span>
                                            </td>
