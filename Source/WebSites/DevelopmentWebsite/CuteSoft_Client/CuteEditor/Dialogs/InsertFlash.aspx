...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head runat="server">
		...
		var OxO36c9=[];function PostBackAction(){<%=Page.GetPostBackEventReference(hiddenAction,"")%>;} ;
		</script>
		<style type="text/css">
...
<input class="formbutton" type="button" value="[[Cancel]]" onclick="do_Close()" />
	...
	return w;      
		...
		<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1003&file=Dialog_InsertFlash.js"></script>
	</body>
</html>
