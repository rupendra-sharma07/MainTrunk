...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		var OxO6e4b=[];function PostBackAction(){<%=Page.GetPostBackEventReference(hiddenAction,"")%>;} ;
		</script>
		<style type="text/css">
...
<input class="formbutton" type="button" value="[[Cancel]]" onclick="do_Close()" id="Button2" />
	...
	<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1003&file=Dialog_InsertDocument.js"></script>
</html>
