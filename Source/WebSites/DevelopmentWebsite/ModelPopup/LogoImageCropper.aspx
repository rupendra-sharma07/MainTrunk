<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LogoImageCropper.aspx.cs" Inherits="ModelPopup_LogoImageCropper" %>
            ...
            <div class="yt-ContentPrimaryContainer">
                 <div class="yt-Error" id="yt-CropperError">
                    ...
                    <asp:ValidationSummary ID="valsError" runat="server" 
                        HeaderText=" <h2>Oops - there was a problem with your photo upload.</h2> <h3>Please correct the errors below:</h3> <br>" />   
                     </div>            
                    </div>
                <div class="yt-ContentPrimary">
                    <fieldset class="yt-Form">
                        ...
                        <asp:Image ID="img" runat="server" ImageUrl="~/assets/images/sample_companyLogo.gif" AlternateText="Upload Image" /></span>
                    </fieldset>
                    <div class="yt-CropImages">
                        <div class="yt-Preview">
                            <h4>
                                <asp:Label ID="lblPreview" runat="server" Text="Preview:"></asp:Label></h4>
                            <div class="yt-UserProfile-Photo">
