<%@ page language="C#" autoeventwireup="true" inherits="Coupons_CouponsList, App_Web_uakbah8f" title="CouponsList" %>
...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen, projection" href="../assets/css/default.css" />
    <!-- default grid layout stylesheet -->
    <link rel="stylesheet" type="text/css" media="screen, projection" href="../assets/css/layouts/centered1024_12.css" />
                                        ...
                                        <asp:GridView ID="gvMyCoupons" CssClass="yt-AdminTable" AutoGenerateColumns="False"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Remove" ShowHeader="False">
                                                    ...
                                                    <HeaderStyle BackColor="#8E7C71" ForeColor="White" Width="100px" />
                                                </asp:TemplateField>
