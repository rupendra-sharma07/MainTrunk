...
<script type="text/javascript" src="Load.ashx?type=dialogscript&verfix=1003&file=Dialog_Tag_Style.js"></script>
...
var OxOd575=["ondblclick","navtd","shiftKey","style"];Window_GetElement(window,OxOd575[1],true)[OxOd575[0]]=function (){if(event[OxOd575[2]]){alert(element[OxOd575[3]].cssText);} ;} ;
</script>
